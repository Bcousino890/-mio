// Datos de ejemplo (fallback cuando la API no responde). Los tipos de dominio
// viven en lib/types.ts — aquí solo se re-exportan por compatibilidad con los
// imports existentes.
import type { Listing, Source, SourceReference } from './types'
