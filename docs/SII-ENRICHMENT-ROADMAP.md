...
| Backlog restante | Watchlists con alertas de backend (requiere jobs), capa de ventas CBR en el mapa (pins/h3), AVM chileno con comparables `sii_comparables_h3_cl`, ETL del dataset CBR |
